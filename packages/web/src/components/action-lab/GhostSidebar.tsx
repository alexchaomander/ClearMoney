    ...
    >
      ...
      <div className="h-1 bg-neutral-900 overflow-hidden">
        <motion.div 
          ...
          initial={{ width: 0 }}
          animate={{ width: `${steps.length > 0 ? (completedSteps.length / steps.length) * 100 : 0}%` }}
        />
      </div>
      ...
      <div className="flex-grow overflow-y-auto p-6 space-y-8">
        ...
        <div className="space-y-4">
          ...
          {steps.length > 0 ? (
            ...
            <div className="p-10 text-center border-2 border-dashed border-neutral-900 rounded-3xl">
              <p className="text-sm text-neutral-500 italic">No execution steps provided for this intent.</p>
            </div>
          )}
        </div>
      </div>
