    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 relative z-10">
        <div className="p-5 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-emerald-500/30 transition-colors group/item">
          <div className="flex items-center gap-2 mb-1">
            <p className="text-xs font-bold uppercase tracking-wider text-slate-400 group-hover/item:text-emerald-400 transition-colors">Total Assets</p>
        ...
        <div className="p-5 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-rose-500/30 transition-colors group/item">
          <p className="text-xs font-bold uppercase tracking-wider text-slate-400 group-hover/item:text-rose-400 transition-colors mb-1">Total Liabilities</p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 relative z-10">
        <div className="p-3 rounded-xl bg-white/5 border border-white/5">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-1">Vested</p>
          <p className="text-sm font-bold text-emerald-500/80">
            <AnimatedAmount value={vestedEquityValue} />
          </p>
        </div>
        <div className="p-3 rounded-xl bg-white/5 border border-white/5">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-1">Unvested</p>
          <p className="text-sm font-bold text-slate-400 italic">
            <AnimatedAmount value={unvestedEquityValue} />
          </p>
        </div>
        <div className="p-3 rounded-xl bg-white/5 border border-white/5">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-1">Tax-Adv</p>
          <p className="text-sm font-bold text-emerald-500/80">
            <AnimatedAmount value={taxAdvantagedValue} />
          </p>
        </div>
        <div className="p-3 rounded-xl bg-white/5 border border-white/5">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-1">Taxable</p>
