      ...
      >
        <section className="px-4 pt-10 pb-8 sm:pt-14">
          <div className="mx-auto max-w-6xl">
            <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6 sm:p-8 shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
        ...
        <section className="px-4 pb-16">
          <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="space-y-6">
              <div className="rounded-3xl border border-white/10 bg-black/35 p-6 backdrop-blur-sm">
                ...
                <div className="mt-5 grid gap-4 sm:grid-cols-2">
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-white/15 bg-black/40 px-3 py-2.5 text-white placeholder:text-neutral-500 focus:border-sky-300/60 focus:outline-none"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-white/15 bg-black/40 px-3 py-2.5 text-white focus:border-sky-300/60 focus:outline-none"
                    >
              ...
              <div className="rounded-3xl border border-white/10 bg-black/35 p-6 backdrop-blur-sm">
                ...
                <div className="mt-4 grid gap-3 rounded-2xl border border-white/10 bg-white/[0.02] p-4 sm:grid-cols-[1fr_1fr_auto]">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-xl border border-white/15 bg-black/40 px-3 py-2.5 text-sm text-white focus:border-sky-300/60 focus:outline-none"
                    >
                  ...
                  <div className="grid gap-3 sm:grid-cols-2 sm:col-span-2">
                    <input
                      ...
                      className="w-full rounded-xl border border-white/15 bg-black/40 px-3 py-2.5 text-sm text-white placeholder:text-neutral-500 focus:border-sky-300/60 focus:outline-none"
                    />
                    <input
                      value={householdName}
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-white/5 px-4 py-2 text-sm text-white hover:bg-white/10"
                  >
                    <Upload className="h-4 w-4" />
                    Import CSV profile
                  </button>
                  {csvImportStatus && (
                    <p className="inline-flex items-center rounded-lg border border-white/10 bg-black/40 px-3 py-2 text-xs text-neutral-300">
                      {csvImportStatus}
                    </p>
                  )}
                </div>
                ...
                <div className="mt-3 grid gap-2 sm:grid-cols-[auto_auto_1fr]">
                  ...
                  {shareLink && (
                    <input
                      value={shareLink}
                      readOnly
                      className="w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2 text-xs text-neutral-300"
                    />
                  )}
                </div>
                            ...
                            <td className="px-3 py-3">
                              <div className="flex justify-end gap-2">
                                <button
                                  ...
                                  className="inline-flex items-center gap-1 rounded-lg border border-white/15 bg-white/5 px-2.5 py-1.5 text-xs text-white hover:bg-white/10"
                                >
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                    ...
                    <div className="mt-3 grid gap-2 sm:grid-cols-[1fr_auto]">
                      <select
                        ...
                        className="rounded-xl border border-white/15 bg-black/40 px-3 py-2 text-xs text-white focus:border-sky-300/60 focus:outline-none"
                      >
                    ...
                    <textarea
                      ...
                      className="mt-2 h-20 w-full resize-none rounded-xl border border-white/15 bg-black/40 p-3 text-xs text-white placeholder:text-neutral-500 focus:border-sky-300/60 focus:outline-none"
                    />
                    <div className="mt-3 max-h-40 space-y-2 overflow-y-auto pr-1">
                      {(commentsQuery.data ?? []).slice(0, 6).map((comment) => (
                        <div key={comment.id} className="rounded-xl border border-white/10 bg-black/30 p-2.5">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                    ...
                    <div className="mt-3 grid gap-2 sm:grid-cols-[1fr_auto_auto]">
                      <input
                        ...
                        className="rounded-xl border border-white/15 bg-black/40 px-3 py-2 text-xs text-white placeholder:text-neutral-500 focus:border-sky-300/60 focus:outline-none"
                      />
                      <select
                    ...
                    <div className="mt-3 max-h-40 space-y-2 overflow-y-auto pr-1">
                      {(collaboratorsQuery.data ?? []).map((collaborator) => (
                        <div key={collaborator.id} className="flex items-center justify-between rounded-xl border border-white/10 bg-black/30 p-2.5">
                          <div>
                ...
                <div className="mt-4 rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                  ...
                  <div className="mt-3 max-h-48 space-y-2 overflow-y-auto pr-1">
                    {(eventsQuery.data ?? []).slice(0, 14).map((event) => (
                      <div key={event.id} className="rounded-xl border border-white/10 bg-black/30 p-2.5">
            ...
            <div className="space-y-6 lg:sticky lg:top-20 lg:h-fit">
              ...
              <div className="rounded-3xl border border-white/10 bg-black/35 p-6 backdrop-blur-sm">
                ...
                <div className="mt-4 space-y-2">
                  {results.strategyImpacts.map((impact) => (
                    <div key={impact.id} className="rounded-xl border border-white/10 bg-white/[0.02] p-3">
              ...
              <div className="rounded-3xl border border-white/10 bg-black/35 p-6 backdrop-blur-sm">
                ...
                <textarea
                  ...
                  readOnly
                  className="mt-3 h-56 w-full resize-none rounded-xl border border-white/10 bg-black/40 p-3 text-xs leading-relaxed text-neutral-200 focus:outline-none"
                />
              </div>
            </div>
          </div>
