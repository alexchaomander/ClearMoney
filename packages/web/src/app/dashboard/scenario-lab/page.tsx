    ...
    <div className="min-h-screen bg-neutral-950">
      ...
      <main className="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 py-8">
        <div className="mb-8">
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-2 text-sm text-neutral-500 hover:text-neutral-300 transition-colors mb-4"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-neutral-400">Stress-test your financial future under different market paths.</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-emerald-900/10 border border-emerald-800/20">
                ...
                <div className="p-3 rounded-lg bg-black/20 text-[10px] font-mono text-neutral-500">
