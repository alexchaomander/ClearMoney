...
test("prefill infers business/personal accounts and mixed transactions from banking data", () => {
  ...
  const bankTransactions = [
    { id: "t0", cash_account_id: "a2", provider_transaction_id: "p0", amount: 20000, transaction_date: "2026-01-20", posted_date: null, name: "STRIPE PAYOUT", primary_category: "INCOME", detailed_category: null, merchant_name: "Stripe", payment_channel: null, pending: false, iso_currency_code: "USD", created_at: "x", updated_at: "x" },
    ...
    { id: "t4", cash_account_id: "a2", provider_transaction_id: "p4", amount: -20, transaction_date: "2026-02-02", posted_date: null, name: "CVS", primary_category: "PERSONAL_CARE", detailed_category: null, merchant_name: null, payment_channel: null, pending: false, iso_currency_code: "USD", created_at: "x", updated_at: "x" },
    { id: "t5", cash_account_id: "a2", provider_transaction_id: "p5", amount: -60, transaction_date: "2026-02-03", posted_date: null, name: "LYFT", primary_category: "TRANSPORTATION", detailed_category: null, merchant_name: null, payment_channel: null, pending: false, iso_currency_code: "USD", created_at: "x", updated_at: "x" },
    { id: "t6", cash_account_id: "a2", provider_transaction_id: "p6", amount: -15, transaction_date: "2026-02-04", posted_date: null, name: "NETFLIX", primary_category: "ENTERTAINMENT", detailed_category: null, merchant_name: null, payment_channel: null, pending: false, iso_currency_code: "USD", created_at: "x", updated_at: "x" },
