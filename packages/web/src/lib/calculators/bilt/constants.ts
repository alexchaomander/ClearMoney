...
export const ASSUME_MIN_SPEND_MET_TEXT =
  "Calculations assume you meet the minimum spend requirements to unlock all Welcome Bonuses.";
...
export const CARD_BENEFITS_TEXT = {
  common: {
    ...
    biltCash:
      "All three Bilt Cards earn 4% back in Bilt Cash on everyday purchases (excluding rent/mortgage).",
  ...
  [BiltCardTier.BLUE]: {
    ...
    description:
      "A no annual fee card that turns your rent, mortgage, and everyday spend into valuable rewards.",
    highlights: [
      "No Annual Fee ($0)",
  ...
  [BiltCardTier.OBSIDIAN]: {
    ...
    description:
      "Designed for members who want more control over their rewards with selectable bonus categories.",
    highlights: [
      "$95 Annual Fee",
  ...
  [BiltCardTier.PALLADIUM]: {
    ...
    description:
      "The premium card offering over $1,000 in annual value with high-value rewards and elevated benefits.",
    highlights: [
      "$495 Annual Fee",
