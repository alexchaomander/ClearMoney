...
export function getDecisionTracePayload(trace: DecisionTrace): DecisionTracePayload | null {
  ...
  return {
    ...
    recommendation_status: typeof raw.recommendation_status === "string" ? raw.recommendation_status : null,
    superseded_by_trace_id: typeof raw.superseded_by_trace_id === "string" ? raw.superseded_by_trace_id : null,
