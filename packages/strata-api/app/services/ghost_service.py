        ...
        return {
            "steps": [
                ...
                },
                {
                    ...
                    "instruction": "Once you have manually completed the action, mark it as done here."
                }
            ]
        }
        ...
        return {
            "steps": [
                ...
                },
                {
                    ...
                    "snippets": [
                        {"label": "Transfer Amount", "value": f"${payload.get('amount', '0.00'):,}", "copy_value": str(payload.get('amount', ''))},
                        {"label": "Source Account", "value": payload.get('source_account_name', 'Checking'), "copy_value": payload.get('source_account_number', '')},
                        {"label": "Target Account", "value": payload.get('target_account_name', 'Savings'), "copy_value": payload.get('target_account_number', '')}
                    ]
                },
                {
                    "order": 3,
                    ...
                    "instruction": "Complete the transfer on the bank site. Return here to mark as done so Strata can verify."
                }
            ]
        }
            ...
            "steps": [
                {
                    ...
                    "url": url,
                    "instruction": "Navigate to the 'Transfer an Account' or 'Rollover' section of your target brokerage."
                },
                {
                    "order": 2,
                    "type": "COPY_DATA",
                    ...
                    "snippets": [
                        {"label": "Source Broker", "value": payload.get('source_institution', 'Fidelity'), "copy_value": payload.get('source_institution', '')},
                        {"label": "DTC Number", "value": payload.get('source_dtc', '0226'), "copy_value": payload.get('source_dtc', '0226')},
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "snippets": [
                        ...
                        {"label": "Buy Amount", "value": f"${payload.get('buy_amount', '0.00'):,}", "copy_value": str(payload.get('buy_amount', ''))}
                    ]
                }
            ]
        }
