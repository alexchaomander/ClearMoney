...
import type { CalculatorInputs } from "@/lib/calculators/estate-tax/types";
...
function daysUntilSunset() {
  const now = new Date();
  const sunsetDate = new Date("2026-01-01T00:00:00");
                ...
                <div className="space-y-6">
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        assets: { ...prev.assets, bankAccounts: value },
                      }))
                    }
                    min={0}
                    max={10000000}
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        assets: { ...prev.assets, brokerageAccounts: value },
                      }))
                    }
                    min={0}
                    max={50000000}
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        assets: { ...prev.assets, primaryResidence: value },
                      }))
                    }
                    min={0}
                    max={20000000}
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        assets: { ...prev.assets, otherRealEstate: value },
                      }))
                    }
                    min={0}
                    max={20000000}
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        assets: { ...prev.assets, lifeInsurance: value },
                      }))
                    }
                    min={0}
                    max={20000000}
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        assets: { ...prev.assets, businessInterests: value },
                      }))
                    }
                    min={0}
                    max={50000000}
                ...
                <div className="space-y-6">
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        liabilities: { ...prev.liabilities, mortgages: value },
                      }))
                    }
                    min={0}
                    max={5000000}
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        liabilities: { ...prev.liabilities, otherDebts: value },
                      }))
                    }
                    min={0}
                    max={2000000}
                ...
                <div className="space-y-6">
                      ...
                      {(["single", "married"] as const).map((status) => (
                        <button
                          ...
                          onClick={() =>
                            setInputs((prev) => ({
                              ...prev,
                              personal: { ...prev.personal, maritalStatus: status },
                            }))
                          }
                          className={cn(
                    ...
                    <div className="mt-2">
                      <select
                        ...
                        onChange={(event) =>
                          setInputs((prev) => ({
                            ...prev,
                            personal: { ...prev.personal, stateOfResidence: event.target.value },
                          }))
                        }
                  ...
                  <SliderInput
                    ...
                    onChange={(value) =>
                      setInputs((prev) => ({
                        ...prev,
                        personal: { ...prev.personal, age: value },
                      }))
                    }
                    min={18}
                    max={100}
                  ...
                  {inputs.personal.maritalStatus === "married" && (
                    <SliderInput
                      ...
                      onChange={(value) =>
                        setInputs((prev) => ({
                          ...prev,
                          personal: { ...prev.personal, spouseAge: value },
                        }))
                      }
                      min={18}
                      max={100}
                  ...
                  <SliderInput
                    ...
                    step={50000}
                    format="currency"
                    description="Gifts above the annual exclusion already using exemption"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-neutral-800 bg-neutral-950/40 p-4">
                ...
                <p className="text-xs text-neutral-500 mt-1">
                  Exemption remaining: {" "}
                  {formatCurrency(results.sunsetComparison.currentLaw.exemptionRemaining, 0)}
                </p>
              </div>
          ...
          <div className="rounded-2xl bg-neutral-900 p-6 space-y-4">
            ...
            <p className="text-sm text-neutral-400">
              {results.state.hasEstateTax
                ? `Your state exemption is ${formatCurrency(
                    results.state.exemption,
                    0
                  )}.`
            ...
            <div className="space-y-3 text-sm text-neutral-300">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-white">
                  {results.state.maxRate > 0
                    ? formatPercent(results.state.maxRate)
                    : "0%"}
                </span>
              </div>
              <div className="flex justify-between">
                ...
                <span className="text-white">
                  {formatCurrency(results.netEstate, 0)}
                </span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-4xl">
          <MethodologySection>
            <p>
              ...
              assets, liabilities, and lifetime taxable gifts you enter. It includes
              life insurance death benefits, retirement accounts, real estate, and
              business interests in the gross estate calculation.
            </p>
            <p>
              Federal estate tax assumes the 2025 exemption of $13.99M per person
              (double for married couples) with a 40% tax rate above the exemption.
              The 2026 sunset comparison models a lower exemption of roughly $7M per
              person.
            </p>
            <p>
              State estate tax estimates use published exemption thresholds and a
              simplified effective rate. New York includes the 5% cliff rule. Results
              are educational estimates, not legal or tax advice.
            </p>
          </MethodologySection>
        </div>
      </section>
